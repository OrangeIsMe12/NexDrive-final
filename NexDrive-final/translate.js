 ...
 * ─────────────────────────────────────────────────────────
 * Utilise un cookie au lieu de localStorage pour sauvegarder
...
(function() {
    ...
    var T = {
        ...
        'apropos.story.p3': { fr: 'Basés au Québec, nous servons des clients à travers toute la province avec un service rapide, humain et professionnel.', en: 'Based in Québec, we serve clients throughout the province with fast, personal, and professional service.' },
        ...
        'engagement.sub': { fr: 'Louer un véhicule, c\'est une question de confiance. Chaque détail reflète ce que nous sommes.', en: 'Renting a vehicle is a matter of trust. Every detail reflects who we are.' },
        ...
        'footer.desc': { fr: 'Location de véhicules premium au Québec, Canada. Réservation en ligne, contrat automatique.', en: 'Premium vehicle rentals in Québec, Canada. Online booking, automatic contract.' },
        'footer.copyright': { fr: '© 2026 NexDrive — Québec, Canada. Tous droits réservés.', en: '© 2026 NexDrive — Québec, Canada. All rights reserved.' },
    };
    ...
    // Lire depuis cookie, fallback fr
